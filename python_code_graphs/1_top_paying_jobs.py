...
top20 = df_unique.sort_values(by="salary_year_avg", ascending=False).head(20)
...
plt.savefig(r"C:\Users\WIN10\Desktop\Job_Analysis_SQL\job_analysis_graphs\top_20_jobs_colombia.png", dpi=300, bbox_inches="tight")
plt.savefig(r"C:\Users\WIN10\Desktop\Job_Analysis_SQL\job_analysis_graphs\top_20_jobs_colombia.pdf", bbox_inches="tight")
plt.show()
